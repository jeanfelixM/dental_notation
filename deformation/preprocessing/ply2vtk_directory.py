...
def ply2vtk():
    # pvpython path
    pvpython_path = "C:/Program Files/ParaView 5.6.2-Windows-msvc2015-64bit/bin/pvpython.exe"
    # Parview script
    script_path = 'F:/work_new/En_cours_new/programmation_python/tools-for-deformetrica/src/preprocessing/ply2vtk_script.py'
