...
def add_colormap_source_directory(root_directory=None, flag_all=1):
    ...
    xml_parameters.read_all_xmls(root_directory / 'model.xmli', root_directory / 'data_set.xml', root_directory /
