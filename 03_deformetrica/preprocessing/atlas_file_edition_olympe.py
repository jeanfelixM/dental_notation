...
The launch_simulation.sh file is formatted for the Olympe server.
...
def write_launch_simulation_atlas_sh(root_directory, xml_parameters):
    ...
    file.write("deformetrica estimate model.xml data_set.xml -p optimization_parameters.xml --output=output > logout.txt\n\n")
    file.write("jobinfo ${SLURM_JOBID}\n")
    file.write("#infoincidentjob\n")
    file.close()
