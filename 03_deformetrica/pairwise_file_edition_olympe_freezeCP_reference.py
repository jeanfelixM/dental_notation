...
def atlas_file_edition(root_directory=None, reference_filename=None, output_folder_name=None, subject_ids=None,
                       ...
                       jobname=None, number_of_nodes=None, number_of_core_per_node=None, number_of_tasks_per_node=None,
                       number_of_gpus=None, number_of_memory=None, time=None, email=None):
